...
<section class="sec dual" id="dual">
    ...
    <div class="dual__block">
        <h3>비티엘의 최신기기</h3>
        <ul class="check-list">
            <li class="hl">관리기계 최신화가 전국 제일 빠른 곳</li>
    ...
    <div class="dual__therapy">
        <img src="<?= $img('therapy-1.gif') ?>" alt="비티엘 수기테라피 – 얼굴 관리" loading="lazy">
        <img src="<?= $img('therapy-2.gif') ?>" alt="비티엘 수기테라피 – 바디 관리" loading="lazy">
    </div>
</section>
