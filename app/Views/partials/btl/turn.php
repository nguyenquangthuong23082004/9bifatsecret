...
$slides = [
    [
        ...
        'quote'  => "저는 다이어트보다 항상 요요가 고민이었는데\n이번에 3개월 -15kg감량 후에는 처음으로\n요요가 안왔어요. 유지까지 책임져주는 곳이라\n너무 신뢰가 갑니다.",
    ],
    [
        'badge' => ['-7kg', '3주'],
        ...
        'quote'  => "단 3주만에 허리라인이 생겼어요. 저는 살도 살이지만\n다리순환이 안되는게 문제였는데 비티엘에서는\n순환자체를 도와주니까 감량과 더불어 부종까지\n빠지니 효과가 빨리 더 잘드러나는 것 같아요",
    ],
    [
        'badge' => ['-12kg', '3개월'],
        ...
        'quote'  => "모태 하체비만이라 아무리 살을 빼도 하체가\n비대해보이는건 포기했었는데, 비티엘에서는\n선택부위만 집중적으로 감량이 가능하니 너무\n신기하네요. 3개월만에 다리라인이 매끈해진게\n확실히 느껴지고 이제서야 상체랑 비율이 맞아서\n옷입는게 재미있어요.",
    ],
    [
        'badge' => ['-15kg', '13주차'],
